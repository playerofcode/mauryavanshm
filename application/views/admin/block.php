                                        ...
                                        <tbody>
                                            ...
                                            foreach ($block as $key): ?>
                                              ...
                                              <!--   <td><?php echo $key->tehsil_id; ?></td> -->
                                                ...
                                                <td><a href="<?php echo base_url('admin/editBlock/'.$key->block_id);?>">Edit</a></td>
                                                <td><a onclick="return confirm('Are you sure?');" href="<?php echo base_url('admin/deleteBlock/'.$key->block_id);?>">Delete</a></td>
                                            <?php $i++;endforeach ?>
                                        </tbody>
                                    </table>
                                </div>
      ...
      <div class="modal-body">
        <form action="<?php echo base_url('admin/addBlock');?>" method="post">
          ...
          <!--   <div class="form-group">
                ...
                <option selected="" disabled="">Choose Tehsil</option>
                </select>
            </div> -->
            <div class="form-group">
