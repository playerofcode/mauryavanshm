<div class="page-wrapper">
            ...
            <?php endif;?>
       			<div class="card ">
       				...
       				<div class="card-body">
       					<form action="<?php echo base_url('admin/add_report');?>" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<textarea name="description" id="ckeditor"  cols="30" rows="5" class="form-control" placeholder="Enter Description" required=""><?php echo set_value('description'); ?></textarea>
