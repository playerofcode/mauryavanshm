            ...
            <?php endif;?>
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php foreach($report as $blog):?>
                                           <tr>
                                                <td><img src="<?php echo base_url().$blog->image;?>" style="height:50px;width:50px;"/></td>
                                                <td><?php echo $blog->title?></td>
                                                <td><?php echo $blog->description?></td>
                                                <td><a href="<?php echo base_url($blog->pdf);?>" target="_blank">View PDF</a></td>  
                                                <td><a href="<?php echo base_url('admin/edit_report/');?><?php echo $blog->id; ?>">Edit</a></td>
                                                <td><a onclick="return confirm('Are you sure want to delete?');"href="<?php echo base_url('admin/delete_report/');?><?php echo $blog->id; ?>">Delete</a></td>
                                           </tr>
                                           <?php endforeach;?>
                                        </tbody>
                                    </table>
