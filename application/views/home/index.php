     <section class="banner--section">
            <div class="banner--slider owl-carousel" data-owl-loop="false">
                <div class="banner--item" data-bg-img="<?php echo base_url('assets/img/slider1.jpg');?>" data-overlay="0.5">
                    <div class="vc--parent">
                        <div class="vc--child">
                            <div class="container">
                                <div class="row row--md-vc">
                                    ...
                                    <div class="col-md-4 col-md-offset-1 col-xs-8 col-xs-offset-2 col-xxs-12">
                                        <!-- Widget Start -->
                                        <div class="widget">
                                            <h2 class="h4 fw--700 widget--title">Member Search</h2>
                    ...
                    <div class="col-md-7 pb--40">
                        <div class="row gutter--15 AdjustRow" data-scroll-reveal="group">
                            <div class="col-xs-4 pb--15">
                                <img src="<?php echo base_url('assets/');?>img/how-it-works-img/01.jpg" alt="">
                            </div>

                            <div class="col-xs-4 pb--15">
                                <img src="<?php echo base_url('assets/');?>img/how-it-works-img/02.jpg" alt="">
                            </div>

                            <div class="col-xs-4 pb--15">
                                <img src="<?php echo base_url('assets/');?>img/how-it-works-img/03.jpg" alt="">
                            </div>

                            <div class="col-xs-12">
                                <img src="<?php echo base_url('assets/');?>img/how-it-works-img/04.jpg" alt="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-5 pb--40">
                        ...
                        <div class="info--items" data-scroll-reveal="group">
                            ...
                            <div class="info--item clearfix">
                                <div class="icon">
                                    <img src="<?php echo base_url('assets/');?>img/how-it-works-img/icon-01.png" alt="">
                                </div>
                            ...
                            <div class="info--item clearfix">
                                <div class="icon">
                                    <img src="<?php echo base_url('assets/');?>img/how-it-works-img/icon-02.png" alt="">
                                </div>
                            ...
                            <div class="info--item clearfix">
                                <div class="icon">
                                    <img src="<?php echo base_url('assets/');?>img/how-it-works-img/icon-03.png" alt="">
                                </div>
                            ...
                            <div class="info--item clearfix">
                                <div class="icon">
                                    <img src="<?php echo base_url('assets/');?>img/how-it-works-img/icon-04.png" alt="">
                                </div>
                ...
                <div class="row row--md-vc">
                    <div class="col-md-6 pb--60">
                        ...
                        <div class="video--popup style--2" data-overlay="0.3">
                            <img src="<?php echo base_url('assets/');?>img/why-choose-us-img/video-poster-2.jpg" alt="">
