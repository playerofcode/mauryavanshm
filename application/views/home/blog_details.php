        <div class="page--header pt--60 pb--60 text-center" data-bg-img="img/page-header-img/bg.jpg" data-overlay="0.85">
            <div class="container">
                ...
                <ul class="breadcrumb text-gray ff--primary">
                    ...
                    <li><a href="<?php echo base_url('home/blog');?>" class="btn-link">Blog</a></li>
                    <li class="active"><span class="text-primary">Blog Details</span></li>
                </ul>
            </div>
        </div>
        <!-- Page Header End -->
                    ...
                    <div class="main--content col-md-8 pb--30" data-trigger="stickyScroll">
                        <div class="main--content-inner">
                            ...
                            <div class="post--item post--single pb--30">
                                <!-- Post Image Start -->
                                <div class="post--img">
                                    <a href="blog-details.html"><img src="<?php echo base_url('assets/');?>img/posts-img/post-item-02.jpg" alt=""></a>
                                </div>
                                <!-- Post Image End -->
                                ...
                                <div class="post--info">
                                    ...
                                    <div class="post--title mt--10">
                                        <h3 class="h4">This Is the Place I Was Telling You About</h3>
                                    </div>
                                    <!-- Post Title End -->
                                    ...
                                    <div class="post--content text-darker mt--10">
                                        ...
                                        <figure class="alignright">
                                            <img src="<?php echo base_url('assets/');?>img/posts-img/post-details-01.jpg" alt="">
                                        ...
                                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum software like Aldus as opposed to using 'Content here, content here', making has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen trusted by holly book.</p>

                                        <p>It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop  sometimes on purpose (injected humour and the like).</p>

                                        <blockquote>
                                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley.</p>

                                            <cite>Larry R. Ramirez</cite>
                                        </blockquote>

                                        <h4>Where can I get some?</h4>

                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat therefore always free from repetition, injected humour, or non-characteristic words etc.</p>
                            ...
                            <div class="post--author pt--40 pb--30">
                                <div class="post--author-inner clearfix" data-bg-img="img/posts-img/author-bg.png">
                                    <div class="img mr--30 text-black text-center float--left">
                                        <img src="<?php echo base_url('assets/');?>img/posts-img/author.jpg" alt="">
                                ...
                                <div class="row AdjustRow">
                                    <div class="col-md-6 pb--30">
                                        ...
                                        <div class="post--item">
                                            <!-- Post Image Start -->
                                            <div class="post--img">
                                                <a href="blog-details.html"><img src="<?php echo base_url('assets/');?>img/posts-img/post-item-01.jpg" alt=""></a>
                                            </div>
                                            <!-- Post Image End -->
                                    ...
                                    <div class="col-md-6 pb--30">
                                        ...
                                        <div class="post--item">
                                            <!-- Post Image Start -->
                                            <div class="post--img">
                                                <a href="blog-details.html"><img src="<?php echo base_url('assets/');?>img/posts-img/post-item-05.jpg" alt=""></a>
                                            </div>
                                            <!-- Post Image End -->
                            ...
                            <div class="comment--list pt--40">
                                ...
                                <ul class="comment--items nav">
                                    <li>
                                        ...
                                        <div class="comment--item mr--15 clearfix">
                                            <div class="img float--left" data-overlay="0.3" data-overlay-color="primary">
                                                <img src="<?php echo base_url('assets/');?>img/comments-img/avatar-01.jpg" alt="">
                                            </div>
                                        ...
                                        <ul class="comment--items nav">
                                            <li>
                                                ...
                                                <div class="comment--item mr--15 clearfix">
                                                    <div class="img float--left" data-overlay="0.3" data-overlay-color="primary">
                                                        <img src="<?php echo base_url('assets/');?>img/comments-img/avatar-02.jpg" alt="">
                                                    </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="comment--item mr--15 clearfix">
                                            <div class="img float--left" data-overlay="0.3" data-overlay-color="primary">
                                                <img src="<?php echo base_url('assets/');?>img/comments-img/avatar-03.jpg" alt="">
                                            </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="comment--item mr--15 clearfix">
                                            <div class="img float--left" data-overlay="0.3" data-overlay-color="primary">
                                                <img src="<?php echo base_url('assets/');?>img/comments-img/avatar-04.jpg" alt="">
                                            </div>
