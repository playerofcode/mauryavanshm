        <div class="cover--header pt--80 text-center" data-bg-img="<?php echo base_url('assets/');?>img/group_home.jpg" data-overlay="0.6" data-overlay-color="white">
            <div class="container">
                <div class="cover--avatar" data-overlay="0.3" data-overlay-color="primary">
                    <img src="<?php echo base_url('assets/');?>img/cover-header-img/avatar-02.jpg" alt="">
                </div>
                    ...
                    <ul class="nav">
                        <li>
                            <a href="member-activity-personal.html" data-overlay="0.3" data-overlay-color="primary">
                                <img src="<?php echo base_url('assets/');?>img/group-img/admin-avatar-01.jpg" alt="">
                            </a>
                        </li>
                        <li>
                            <a href="member-activity-personal.html" data-overlay="0.3" data-overlay-color="primary">
                                <img src="<?php echo base_url('assets/');?>img/group-img/admin-avatar-02.jpg" alt="">
                            </a>
                        </li>
                        <li>
                            <a href="member-activity-personal.html" data-overlay="0.3" data-overlay-color="primary">
                                <img src="<?php echo base_url('assets/');?>img/group-img/admin-avatar-03.jpg" alt="">
                            </a>
                        </li>
                    </ul>
                        ...
                        <div class="main--content-inner drop--shadow">
                            ...
                            <div class="content--nav pb--30">
                                <ul class="nav ff--primary fs--14 fw--500 bg-lighter">
                                    ...
                                    <li><a href="group-members.html">Members</a></li>
                                ...
                                <ul class="activity--items nav">
                                        ...
                                        <div class="activity--item">
                                            <div class="activity--avatar">
                                                <a href="member-activity-personal.html">
                                                    <img src="<?php echo base_url('assets/');?>img/activity-img/avatar-01.jpg" alt="">
                                                </a>
                                            </div>

                                            <div class="activity--info fs--14">
                                                <div class="activity--header">
                                                    <p><a href="member-activity-personal.html">Eileen K. Ruiz</a> joined the group <a href="group-home.html">Food Recipes</a></p>
                                                </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="activity--item">
                                            <div class="activity--avatar">
                                                <a href="member-activity-personal.html">
                                                    <img src="<?php echo base_url('assets/');?>img/activity-img/avatar-02.jpg" alt="">
                                                </a>
                                            </div>

                                            <div class="activity--info fs--14">
                                                <div class="activity--header">
                                                    <p><a href="member-activity-personal.html">Samuel C. Azevedo</a> posted an update in the group <a href="group-home.html">Food Recipes</a></p>
                                                </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="activity--item">
                                            <div class="activity--avatar">
                                                <a href="member-activity-personal.html">
                                                    <img src="<?php echo base_url('assets/');?>img/activity-img/avatar-03.jpg" alt="">
                                                </a>
                                            </div>

                                            <div class="activity--info fs--14">
                                                <div class="activity--header">
                                                    <p><a href="member-activity-personal.html">Denise R. Sherman</a> shared her new experience about recipes in the group <a href="group-home.html">Food Recipes</a></p>
                                                </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="activity--item">
                                            <div class="activity--avatar">
                                                <a href="member-activity-personal.html">
                                                    <img src="<?php echo base_url('assets/');?>img/activity-img/avatar-04.jpg" alt="">
                                                </a>
                                            </div>

                                            <div class="activity--info fs--14">
                                                <div class="activity--header">
                                                    <p><a href="member-activity-personal.html">Leticia J. Espinosa</a> posted an update in the group <a href="group-home.html">Food Recipes</a></p>
                                                </div>
                                                        ...
                                                        <li>
                                                            <div class="acomment--item clearfix">
                                                                <div class="acomment--avatar">
                                                                    <a href="member-activity-personal.html">
                                                                        <img src="<?php echo base_url('assets/');?>img/activity-img/avatar-05.jpg" alt="">
                                                                    </a>
                                                                </div>

                                                                <div class="acomment--info">
                                                                    <div class="acomment--header">
                                                                        <p><a href="member-activity-personal.html">Lee E. Jones</a> Replied</p>
                                                                    </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="activity--item">
                                            <div class="activity--avatar">
                                                <a href="member-activity-personal.html">
                                                    <img src="<?php echo base_url('assets/');?>img/activity-img/avatar-06.jpg" alt="">
                                                </a>
                                            </div>

                                            <div class="activity--info fs--14">
                                                <div class="activity--header">
                                                    <p><a href="member-activity-personal.html">Bonnie P. Rock</a> shared a link in the group <a href="group-home.html">Food Recipes</a></p>
                                                </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="activity--item">
                                            <div class="activity--avatar">
                                                <a href="member-activity-personal.html">
                                                    <img src="<?php echo base_url('assets/');?>img/activity-img/avatar-07.jpg" alt="">
                                                </a>
                                            </div>

                                            <div class="activity--info fs--14">
                                                <div class="activity--header">
                                                    <p><a href="member-activity-personal.html">Anita J. Lilley</a> posted an update in the group <a href="group-home.html">Food Recipes</a></p>
                                                </div>
                                                        ...
                                                        <ul class="nav AdjustRow">
                                                            <li>
                                                                <a href="img/activity-img/gallery-embed-01.jpg">
                                                                    <img src="<?php echo base_url('assets/');?>img/activity-img/gallery-embed-01.jpg" alt="">
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="img/activity-img/gallery-embed-02.jpg">
                                                                    <img src="<?php echo base_url('assets/');?>img/activity-img/gallery-embed-02.jpg" alt="">
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="img/activity-img/gallery-embed-03.jpg">
                                                                    <img src="<?php echo base_url('assets/');?>img/activity-img/gallery-embed-03.jpg" alt="">
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="img/activity-img/gallery-embed-04.jpg" data-overlay="0.5">
                                                                    <img src="<?php echo base_url('assets/');?>img/activity-img/gallery-embed-04.jpg" alt="">
                                                                    <span>24+ More</span>
                                                                </a>
                                                            </li>
                                                        </ul>
