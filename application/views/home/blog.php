                            ...
                            <div class="row MasonryRow">
                                <div class="col-sm-6 col-xs-12 pb--30">
                                    ...
                                    <div class="post--item" data-scroll-reveal="bottom">
                                        <!-- Post Image Start -->
                                        <div class="post--img">
                                            <a href="<?php echo base_url('home/blog_details');?>"><img src="<?php echo base_url('assets/');?>img/posts-img/post-item-01.jpg" alt=""></a>
                                        </div>
                                        <div class="post--info">
                                            <!-- Post Meta Start -->
                                            <div class="post--meta">
                                                <ul class="nav">
                                                    <li>
                                                        <a href="#">
                                                            <img src="<?php echo base_url('assets/');?>img/posts-img/avatar-small-01.jpg" alt="">
                                            ...
                                            <div class="post--title mt--10">
                                                <h3 class="h6">
                                                    <a href="<?php echo base_url('home/blog_details');?>" class="btn-link">This Is the Place I Was Telling You About</a>
                                                </h3>
                                            </div>
                                            <!-- Post Title End -->
                                            ...
                                            <div class="post--action text-darkest mt--8">
                                                <a href="<?php echo base_url('home/blog_details');?>" class="btn-link">Continue Reading<i class="ml--10 text-primary fa fa-caret-right"></i></a>
                                            </div>
                                            <!-- Post Action End -->
                                        </div>
                                        <!-- Post Info End -->
                                ...
                                <div class="col-sm-6 col-xs-12 pb--30">
                                    ...
                                    <div class="post--item" data-scroll-reveal="bottom">
                                        <!-- Post Image Start -->
                                        <div class="post--img">
                                            <a href="<?php echo base_url('home/blog_details');?>"><img src="<?php echo base_url('assets/');?>img/posts-img/post-item-02.jpg" alt=""></a>
                                        </div>
                                        <!-- Post Image End -->
                                        ...
                                        <div class="post--info">
                                            ...
                                            <div class="post--meta">
                                                <ul class="nav">
                                                    <li>
                                                        <a href="#">
                                                            <img src="<?php echo base_url('assets/');?>img/posts-img/avatar-small-02.jpg" alt="">
                                            ...
                                            <div class="post--title mt--10">
                                                <h3 class="h6">
                                                    <a href="<?php echo base_url('home/blog_details');?>" class="btn-link">Your guide to perfect rebranding</a>
                                                </h3>
                                            </div>
                                            <!-- Post Title End -->
                                ...
                                <div class="col-sm-6 col-xs-12 pb--30">
                                    ...
                                    <div class="post--item" data-scroll-reveal="bottom">
                                        ...
                                        <div class="post--video">
                                            <a href="<?php echo base_url('home/blog_details');?>"><img src="<?php echo base_url('assets/');?>img/posts-img/post-item-03.jpg" alt=""></a>
                                        </div>
                                        <!-- Post Video End -->
                                        ...
                                        <div class="post--info">
                                            ...
                                            <div class="post--meta">
                                                <ul class="nav">
                                                    <li>
                                                        <a href="#">
                                                            <img src="<?php echo base_url('assets/');?>img/posts-img/avatar-small-03.jpg" alt="">
                                                            <span>Carla W. Carter</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                            ...
                                            <div class="post--title mt--10">
                                                <h3 class="h6">
                                                    <a href="<?php echo base_url('home/blog_details');?>" class="btn-link">Treat Your Pet's Skin the Way You Treat Your Own with Pet Caress + a Fun Twitter Party</a>
                                                </h3>
                                            </div>
                                            <!-- Post Title End -->
                                ...
                                <div class="col-sm-6 col-xs-12 pb--30">
                                    ...
                                    <div class="post--item" data-scroll-reveal="bottom">
                                        ...
                                        <div class="post--info">
                                            ...
                                            <div class="post--title mt--10">
                                                <h3 class="h6">
                                                    <a href="<?php echo base_url('home/blog_details');?>" class="btn-link">Classroomscreen.com: A Web Tool Teachers and Students will LOVE lorem ipsum has been the industries unknow printer took galley</a>
                                                </h3>
                                            </div>
                                            <!-- Post Title End -->
                                ...
                                <div class="col-sm-6 col-xs-12 pb--30">
                                    ...
                                    <div class="post--item" data-scroll-reveal="bottom">
                                        <!-- Post Image Start -->
                                        <div class="post--img">
                                            <a href="<?php echo base_url('home/blog_details');?>"><img src="<?php echo base_url('assets/');?>img/posts-img/post-item-04.jpg" alt=""></a>
                                        </div>
                                        <!-- Post Image End -->
                                        ...
                                        <div class="post--info">
                                            ...
                                            <div class="post--meta">
                                                <ul class="nav">
                                                    <li>
                                                        <a href="#">
                                                            <img src="<?php echo base_url('assets/');?>img/posts-img/avatar-small-04.jpg" alt="">
                                            ...
                                            <div class="post--title mt--10">
                                                <h3 class="h6">
                                                    <a href="<?php echo base_url('home/blog_details');?>" class="btn-link">Tasty Stuffed Potato Dumplings Vegan</a>
                                                </h3>
                                            </div>
                                            <!-- Post Title End -->
                                ...
                                <div class="col-sm-6 col-xs-12 pb--30">
                                    ...
                                    <div class="post--item" data-scroll-reveal="bottom">
                                        <!-- Post Image Start -->
                                        <div class="post--img">
                                            <a href="<?php echo base_url('home/blog_details');?>"><img src="<?php echo base_url('assets/');?>img/posts-img/post-item-05.jpg" alt=""></a>
                                        </div>
                                        <!-- Post Image End -->
                                        ...
                                        <div class="post--info">
                                            ...
                                            <div class="post--meta">
                                                <ul class="nav">
                                                    <li>
                                                        <a href="#">
                                                            <img src="<?php echo base_url('assets/');?>img/posts-img/avatar-small-05.jpg" alt="">
                                            ...
                                            <div class="post--title mt--10">
                                                <h3 class="h6">
                                                    <a href="<?php echo base_url('home/blog_details');?>" class="btn-link">You Don't Need a Studio for Pro Portraits -- Make the Most of What You DO Have</a>
                                                </h3>
                                            </div>
                                            <!-- Post Title End -->
                                        ...
                                        <div class="post--info">
                                            ...
                                            <div class="post--meta">
                                                <ul class="nav">
                                                    <li>
                                                        <a href="#">
                                                            <img src="<?php echo base_url('assets/');?>img/posts-img/avatar-small-06.jpg" alt="">
                                            ...
                                            <div class="post--title mt--10">
                                                <h3 class="h6">
                                                    <a href="<?php echo base_url('home/blog_details');?>" class="btn-link">Bodak Yellow Cardi B / @IAMCARDIB</a>
                                                </h3>
                                            </div>
                                            <!-- Post Title End -->
