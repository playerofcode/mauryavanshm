        <div class="page--header pt--60 pb--60 text-center" data-bg-img="<?php echo base_url('home/assets/');?>img/page-header-img/bg.jpg" data-overlay="0.85">
            <div class="container">
                <div class="title">
                    <h2 class="h1 text-white">Activity</h2>
                </div>
                <ul class="breadcrumb text-gray ff--primary">
                    <li><a href="<?php echo base_url();?>" class="btn-link">Home</a></li>
                    <li class="active"><span class="text-primary">Side-Wide Activities</span></li>
                </ul>
            </div>
        </div>
                                ...
                                <ul class="activity--items nav">
                                        ...
                                        <div class="activity--item">
                                            ...
                                            <div class="activity--info fs--14">
                                                ...
                                                <div class="activity--content">
                                                    <div class="img--embed">
                                                        <img src="<?php echo base_url('assets/');?>img/activity-img/profile-pic-01.jpg" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="activity--content">
                                                    <div class="link--embed">
                                                        ...
                                                        <div class="link--video">
                                                            <img src="<?php echo base_url('assets/');?>img/activity-img/link-video-poster.jpg" alt="">
                                                        </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="activity--item">
                                            <div class="activity--avatar">
                                                <a href="member-activity-personal.html">
                                                    <img src="<?php echo base_url('assets/');?>img/activity-img/avatar-08.jpg" alt="">
                                                </a>
                                            </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="activity--item">
                                            <div class="activity--avatar">
                                                <a href="member-activity-personal.html">
                                                    <img src="<?php echo base_url('assets/');?>img/activity-img/avatar-09.jpg" alt="">
                                                </a>
                                            </div>
